---
name: llm-council
description: "Run any question, idea, or decision through a council of 5 AI advisors who independently analyze it, anonymously peer-review and rank each other, and synthesize a final verdict under a strict word cap. MANDATORY TRIGGERS: 'council this', 'run the council', 'war room this', 'pressure-test this', 'stress-test this', 'debate this'. STRONG TRIGGERS: 'should I X or Y', 'which option', 'what would you do', 'is this the right move', 'validate this', 'get multiple perspectives', 'I can't decide', 'I'm torn between'. PROACTIVE: even with no phrase, if the user is visibly mid-decision with real stakes and multiple options and hasn't invoked the council, offer to run it — do not auto-run, ask first. Do NOT trigger on simple yes/no questions, factual lookups, or casual 'should I' without real tradeoff. DO trigger on genuine high-stakes decisions with multiple options."
---
